 ...
 * @paramType T Type of the value to compare.
 ...
 * @paramType T Type of the value that will be returned.
 * @returns Value.
 * @category SimpleFunction
 */
 ...
 * @paramType T Type of the value provided.
 * @category SimpleFunction
 */
 ...
 * @paramType T Input value's type.
 * @paramType U Output value's type.
 * @category SimpleFunction
 */
